            ...
            <div class="card mb-0">
              <div class="card-body">
                <a href="./index.html" class="text-nowrap logo-img text-center d-block py-3 w-100">
                  <img src="../assets/img/logos/logo.png" width="180" alt="">
                </a>
                <div class="text-center">
                  <p class="h5 text-gray-900 mb-2">LAYAD "Layanan Aduan"</p>
                </div>
                <form class="user" method="POST" action="{{ route('login') }}">
                    ...
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        ...
                        <a class="text-primary fw-bold" href="lupa password.html">lupa password?</a>
                    </div>
